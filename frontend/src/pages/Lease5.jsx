...
const Lease5 = () => {
    ...
    const handleDateChange = (dates, index) => {
        ...
        updated[index] = { startDate: start, endDate: end };
        ...
        <div className="flex flex-col gap-12 p-10">
            <div className="bg-white bg-opacity-70 p-10 pt-6 pb-0 rounded-lg shadow-md">
                ...
                <div className='flex flex-row border border-gray-500 rounded-md mb-6 p-1'>
                    ...
                    <textarea
                        className='bg-gray-100 bg-opacity-70 focus:outline-none rounded-md p-4 w-full font-thin text-2xl'
                        type="text" 
                        name="rent"
                        rows='1'
                ...
                <div className='border border-gray-500 rounded-md mb-8 p-1'>
                    ...
                    <div className='flex flex-row justify-between' >
                        ...
                        <textarea
                            className='bg-gray-100 bg-opacity-70 focus:outline-none rounded-md w-1/6 font-thin text-sm'
                            type="text" 
                            name="rent"
                            rows='1'
                            //onChange={handleTitleChange}
