    ...
    <div className='bg-custom-image-3 bg-cover bg-center h-screen'>
        <div className='flex justify-center'>
            <div className='flex flex-col'>
                <h1 className='text-8xl text-white mt-56'>Welcome to Haven</h1>
                <h3 className='text-2xl text-white font-bold mt-10'>Mid-term rentals for traveling professionals, students, and more.</h3>
