          ...
          <div className='flex justify-center'>
              <div className='flex flex-col bg-white bg-opacity-90 rounded-2xl mt-28 p-14'>
                  ...
                  <button className='text-md sm:text-lg text-white hover:bg-white bg-slate-50 px-6 py-2 rounded-full mr-10'>
                    <NavLink to="list-your-property" onClick={closeMenu} className="flex flex-row text-stone-700">I'm listing my place <FaArrowRight className='mt-1 ml-5 text-[rgb(250,112,99)]'/></NavLink>
                  </button>
              </div>
              </div>
          </div>
